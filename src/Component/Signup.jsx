...
function Signup() {
  ...
  <div className="w-11/12 p-8 m-auto bg-gray-900 rounded-lg sm:w-96 bg-clip-padding">
    <div className="space-y-2">
      ...
      <div>
        <div className="space-x-1 text-sm text-center md:text-base font-nunito">
          <span>New to Volcano🌋?</span>
          <a className="font-semibold text-blue-500" href="/create">
            Create Account
          </a>
        </div>
      </div>
    ...
    <div className="mt-10">
      ...
      <div className="mt-4">
        <button className="w-full p-2 text-sm font-normal text-center transition duration-100 bg-black rounded-md md:text-lg font-roboto focus:outline-none hover:shadow-lg">
