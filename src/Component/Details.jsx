        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
            <div className="px-6 py-12 md:px-12">
              <h2 className="text-3xl font-bold mb-4 text-blue-900 display-5">
                Why is it so great?
              </h2>
              ...
              <div className="grid lg:gap-x-12 md:grid-cols-3">
                ...
                <div className="mb-12 md:mb-0">
                  <h2 className="text-3xl font-bold text-blue-900 mb-4">70%</h2>
                  <h5 className="text-lg font-medium text-gray-500 mb-0">
                    Growth
                  </h5>
                </div>
                <div className="">
                  <h2 className="text-3xl font-bold text-blue-900 mb-4">49</h2>
                  <h5 className="text-lg font-medium text-gray-500 mb-0">
                    Projects
                  </h5>
                </div>
                ...
                <div className="flex justify-center items-center h-full">
                  <div className="px-6 py-12 md:px-12 text-white text-center">
                    <h3 className="text-2xl uppercase font-bold mb-6">
                      The future is{" "}
                      <u style={{ color: "hsl(231, 52.6%, 85%)" }}>now</u>
                    </h3>
